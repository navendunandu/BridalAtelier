    ...
    <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4">
        <div class="single-footer-caption mb-50">
            <div class="footer-tittle">
                <h4>Category</h4>
                <ul>
                    <li><a href="#">Bridal Attires</a></li>
                    <li><a href="#">Wedding Ornaments</a></li>
    ...
    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
        <div class="single-footer-caption mb-50">
            <div class="footer-tittle">
                <h4>Get in touch</h4>
                <ul>
                    <li><a href="#">(91) 982-278 3560</a></li>
                    <li><a href="#">thebridalateilierr@gmail.com</a></li>
                    <li><a href="#">67/A, Colorlib, Green road, Ernakulam</a></li>
                </ul>
            </div>
        </div>
    </div>
