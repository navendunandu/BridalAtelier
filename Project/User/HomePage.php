...
<body class="full-wrapper">
                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <div class="header-left d-flex align-items-center">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="index.html"><img src="../Assets/Templates/Main/assets/img/logo/logo.png"
                                        alt=""></a>
                            </div>
                            <!-- Main-menu -->
                                ...
                                <ul class="d-flex align-items-center">
                                    <li class="mr-15">
                                        <div class="nav-search search-switch">
                                            <a href="Search.php"><i class="ti-search"></i></a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="card-stor">
                                            <a href="MyCart.php"> <img
                                                    src="../Assets/Templates/Main/assets/img/gallery/card.svg"
                                                    alt=""></a>
                                            <span>0</span>
                                        </div>
                                    </li>
    ...
    <main>
        ...
        <section class="collection section-bg2 section-padding30 section-over1 ml-15 mr-15"
            data-background="../Assets/Templates/Main/assets/img/gallery/section_bg02.png">
            <div class="container-fluid"></div>
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9">
                    <div class="single-question text-center">
                        <h2 class="wow fadeInUp" data-wow-duration="2s" data-wow-delay=".1s">"Selecting a wedding dress
                            is more than just a fitting... it's a process- a memory in the making"</h2>
                        <a href="about.html" class="btn wow fadeInUp" data-wow-duration="2s"
                            ...
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-35">
                                    <a href="index.html"><img
                                            src="../Assets/Templates/Main/assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
