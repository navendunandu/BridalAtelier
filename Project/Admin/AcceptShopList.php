...
if(isset($_GET['rid']))
{
$UpQry="update tbl_shop set shop_vstatus=2 where shop_vstatus=1 and shop_id=".$_GET['rid'];
if($con->query($UpQry))
{
    ?>
        <script>
...
<body>
    <div class="container">
        <h2 class="mb-4 text-center">Shop List</h2>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <img src="../Assets/Files/Shop/Logo/<?php echo $row['shop_logo']; ?>" alt="Shop Logo" />
                            </td>
                            <td>
                                <a class="action-link" href="AcceptShopList.php?rid=<?php echo $row['shop_id']; ?>">Reject</a>
