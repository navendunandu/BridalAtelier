...
if(isset($_GET['aid']))
	{ 
		$UpQry="update tbl_product set product_vstatus=1 where product_vstatus=0 and  product_id=".$_GET['aid'];
		if($con->query($UpQry))
	{
		echo "Updated";
	}
	else
	{
	 ...
	 if(isset($_GET['rid']))
	{
	$UpQry="update tbl_product set product_vstatus=2 where product_vstatus=0 and product_id=".$_GET['rid'];
	if($con->query($UpQry))
	{
		echo "Updated";
	}
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="action-links">
                    <a href="NewProduct.php?aid=<?php echo $row['product_id']; ?>" class="btn btn-success btn-sm">Accept</a>
                    <a href="NewProduct.php?rid=<?php echo $row['product_id']; ?>" class="btn btn-danger btn-sm">Reject</a>
                </td>
            </tr>
            <?php
            }
