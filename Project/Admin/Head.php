                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="MainCategory.php" class="dropdown-item">Main Category</a>
                            <a href="Category.php" class="dropdown-item">Category</a>
                            <a href="Subcategory.php" class="dropdown-item">Subcategory</a>
                            <a href="Material.php" class="dropdown-item">Material</a>
                        </div>
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Shop</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="ShopList.php" class="dropdown-item">New Shops</a>
                            <a href="AcceptShopList.php" class="dropdown-item">Accepted Shop List</a>
                            <a href="RejectShopList.php" class="dropdown-item">Rejected Shop List</a>
                        </div>
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Product</a>
                        <div class="dropdown-menu bg-transparent border-0">
                        <a href="NewProduct.php" class="dropdown-item">New Product List</a>
                            <a href="AcceptProductList.php" class="dropdown-item">Accepted Product List</a>
                            <a href="RejectProductList.php" class="dropdown-item">Rejected Product List</a>
                        </div>
                        <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Manage Location</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="district.php" class="dropdown-item">Districts</a>
                            <a href="Place.php" class="dropdown-item">Places</a>
                        </div>
                        <a href="UserList.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>CustomerList</a>
                        <a href="ViewBooking.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Booking details</a>
                        <a href="ChangePassword.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Manage Password</a>
